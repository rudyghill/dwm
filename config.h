...
// static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon,"-fn",dmenufont,"-p","execvte:","-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon,"-fn",dmenufont,"-p","execvte:", NULL };
